...
class AppDelegate : UIResponder , UIApplicationDelegate,  GDiOSDelegate {
    ...
    func handle(_ anEvent: GDAppEvent) {
        ...
        case .policyUpdate:
            ...
            //Update UI in ViewController according to values from GDiOS.sharedInstance().getApplicationPolicyString()
    ...
    func processApplicationConfig(_ appConfig: [String : Any]) {
