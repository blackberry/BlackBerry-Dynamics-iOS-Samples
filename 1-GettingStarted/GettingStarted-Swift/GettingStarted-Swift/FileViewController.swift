...
class FileViewController: UIViewController {
    ...
    //File Names
    let textFilename = "File.txt"
    let folderName = "Folder"
    let renamedFile = "NewFile.txt"
    ...
    @IBAction func loadFromFile(_ sender: Any) {
        ...
        if (fileManager.fileExists(atPath: filePath) == true) {
            ...
            //Use FileHandle to get data
            var fileHandle = FileHandle.init()
            do {
                fileHandle = try FileHandle.init(forReadingFrom: URL.init(string: filePath)!)
            }
            catch {
    ...
    func writeMyFile() -> Bool {
        ...
        //Create a secure file uisng FileManager
