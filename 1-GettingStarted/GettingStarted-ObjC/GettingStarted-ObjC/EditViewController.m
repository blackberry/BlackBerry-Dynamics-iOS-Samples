...
- (IBAction)saveInfo:(id)sender {
    ...
    else
    {
        ...
        query = [NSString stringWithFormat:@"INSERT INTO CONTACTS (firstName, lastName, email) VALUES (\"%@\", \"%@\", \"%@\")", self.firstNameText.text, self.lastNameText.text, self.emailText.text];
    }
