...
#import "SimpleTestGDiOSDelegate.h"

@interface SimpleTestGDiOSDelegate ()
...
@implementation SimpleTestGDiOSDelegate

+ (instancetype)sharedInstance {

    static SimpleTestGDiOSDelegate *gdiOSDelegate = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        gdiOSDelegate = [[SimpleTestGDiOSDelegate alloc] init];
    });
