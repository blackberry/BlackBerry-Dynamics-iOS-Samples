...
This sample demonstrates various REST and SOAP APIs including authentication to UEM, automating administrative tasks, and integrations with BlackBerry UEM.
...
2. Install Cocoapods in the project.
3. Import GD.framework in the project.
4. Open the project in XCode
5. Open the info.plist file and update the GDApplicationID to be unique.
