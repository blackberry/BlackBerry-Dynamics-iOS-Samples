...
@interface GreetingsServerUITests : XCTestCase

@end

@implementation GreetingsServerUITests
...
{    
    ...
    BOOL mainUIShown = [ats isScreenShown:GRSMainViewID timeout:10.f];
    
    if (!mainUIShown && UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        [application swipeRight];
        mainUIShown = [ats isScreenShown:GRSMainViewID timeout:10.f];
    }
