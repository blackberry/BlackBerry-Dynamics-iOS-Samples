...
@interface AppKinetics_SaveEditClientUITests : XCTestCase

@end

@implementation AppKinetics_SaveEditClientUITests
...
{    
    ...
    BOOL mainUIShown = [ats isScreenShown:ASECMainViewID timeout:10.f];
