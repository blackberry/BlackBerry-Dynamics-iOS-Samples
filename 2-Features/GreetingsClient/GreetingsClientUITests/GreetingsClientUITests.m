...
@interface GreetingsClientUITests : XCTestCase

@end

@implementation GreetingsClientUITests
...
- (void)testProvision
{
    ...
    BOOL mainUIShown = [ats isScreenShown:GRCMainViewID timeout:10.f];
    
    if (!mainUIShown && [[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        [application swipeRight];
        mainUIShown = [ats isScreenShown:GRCMainViewID timeout:10.f];
    }
