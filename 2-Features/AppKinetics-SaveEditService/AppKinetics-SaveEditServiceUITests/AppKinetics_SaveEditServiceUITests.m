...
@interface AppKinetics_SaveEditServiceUITests : XCTestCase

@end

@implementation AppKinetics_SaveEditServiceUITests
...
{    
    ...
    BOOL mainUIShown = [ats isScreenShown:AKSMainViewID timeout:10.f];
