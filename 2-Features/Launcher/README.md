...
How to customised the BlackBerry Dynamics Launcher.

## Description

The “Launcher” is a UX concept whereby an icon is displayed permanently on each screen, “floating” over the content. From the Launcher a user is able to launch other BlackBerry Dynamics apps, as well as take Quick Actions such as compose an email or schedule a meeting. By default the launcher is enabled in BlackBerry Dynamics applications. 

This sample demonstrates how to apply custom menu options and styling to the Settings menu.
