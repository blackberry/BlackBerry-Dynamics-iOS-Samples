...
struct Constants {
    static let servicesClientApplicationGDIdentifier = "com.good.example.sdk.services-client"
    static let servicesServerApplicationGDIdentifier = "com.good.example.sdk.services-server"
    ...
    static let serviceConfigDidChangeNotification = "kServiceConfigDidChangeNotification"
