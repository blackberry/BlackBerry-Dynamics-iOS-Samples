# Services Client - Simple Consumer

## Description

This BlackBerry Dynamics sample application demonstrates how to use the AppKinetics programming interface as a consumer. It is intended for use with the
AppKinetics ServicesServerSwift sample.
...
7. Edit the *GDApplicationID* to your own or use the default '*com.blackberry.dynamics.sample.consumer*' in the *info.plist*.
