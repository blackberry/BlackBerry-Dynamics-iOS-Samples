...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [RSSReaderGDiOSDelegate sharedInstance].rssReaderAppDelegate = self;
    //Set the main window
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    NSLog(@"applicationDidBecomeActive: getAuthDelegate Name = %@, address = %@, applicationId = %@, isAuthenticationDelegated = %@",
