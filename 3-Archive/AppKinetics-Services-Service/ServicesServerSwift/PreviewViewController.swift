...
class PreviewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.accessibilityIdentifier = UIAccessibilityIdentifiers.SSSPreviewViewID
    }
    
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        guard let url = viewModel.url else {return}
        self.webView.load(viewModel.data as Data, mimeType: "application/pdf", characterEncodingName: "utf-8", baseURL: url)
    }
