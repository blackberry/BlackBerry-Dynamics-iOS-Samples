# BEMS and Mobile Services - Objective C
...
## Prerequisites
1. BEMS - Steps to install [BEMS](https://docs.blackberry.com/en/endpoint-management/blackberry-enterprise-mobility-server)
